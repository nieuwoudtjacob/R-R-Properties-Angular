...
export class StandardsComponent {
  ...
  openPDF1() {
    window.open('../../../assets/Pdfs/standards/IVSC_effective_31_January_2022__1_.pdf', '_blank');
  }
  openPDF2() {
    window.open('../../../assets/Pdfs/standards/SA_Standards_sMVPR2021_23_Ver9.1a.pdf', '_blank');
  }
