...
@Component({
  selector: 'app-lodgealegalcaseorcomplaint',
  templateUrl: './lodgealegalcaseorcomplaint.component.html',
  styleUrls: ['./lodgealegalcaseorcomplaint.component.scss']
})
export class LodgealegalcaseorcomplaintComponent {
  construction = false;
  top = false;
